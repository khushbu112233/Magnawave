...
import com.jlouistechnology.magnawave.Adapter.ClientAddnewpatAdapter;
...
import com.jlouistechnology.magnawave.databinding.FragmentClientsAddNewPatBinding;
...
public class ClientAddNewPatFragment extends Fragment {

    FragmentClientsAddNewPatBinding mBinding;
    View rootView;
    Context context;
    Filter filter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_clients_add_new_pat, container, false);
        rootView = mBinding.getRoot();
        context = getActivity();
        mBinding.txtTitle.setText(Pref.getValue(context,"selected_animal","").toUpperCase()+" "+"CLIENTS");
    ...
    public void set_adapter()
    {
        ...
        ClientAddnewpatAdapter adapter=new ClientAddnewpatAdapter(context,clientArrayList);
        mBinding.clientList.setAdapter(adapter);
        adapter.setOnClickFilterListener(onClickFilterListener);
        Pref.setValue(context,"rec_size_new",clientArrayList.size());
        ...
        if(clientArrayList.size()==0)
        {
            ...
            alertDialogBuilder.setMessage("Do you want to add new client?");
    ...
    public void call_api_to_get_client_list()
    {
        if(cd.isConnectingToInternet()) {
            ...
            new ExecuteTask_account_type().execute(WebService.CLIENTS);
        }else
        {
    ...
    class ExecuteTask_account_type extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String res = WebService.GetData(WebService.CLIENTS, Pref.getValue(context,"token",""));
            Log.e("res....", "" + res);
                ...
                if(json2.getString("status").equals("true"))
                {
                    ...
                    if(json2.getString("response_code").equals("200")) {
                        ...
                        for(int i=0;i<jsonArray_data.length();i++)
                        {
                            ...
                            clients[i].setAddress(jsonArray_data.getJSONObject(i).getString("address"));
