...
public class EditPatDetailsInfoRecyclerViewAdapter extends RecyclerSwipeAdapter<EditPatDetailsInfoRecyclerViewAdapter.SimpleViewHolder> {
    ...
    public EditPatDetailsInfoRecyclerViewAdapter(Context context, ArrayList<Pat_client_details> objects) {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_animal_details_report_edit, parent, false);
    ...
    public void onBindViewHolder(final SimpleViewHolder viewHolder, final int position) {
        ...
        if(pat_detail_list.get(position).getBp_desc().length()>0) {
